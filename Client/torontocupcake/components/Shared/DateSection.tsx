    ...
    return (
        <div className="flex justify-center items-center">
            <section className="w-screen lg:w-3/4 flex flex-col items-center justify-center py-6 bg-[#CA8787] rounded-t-lg shadow-md shadow-[#A87676]">
                <h1 className="text-[#FFDDCC] font-medium text-2xl cursor-default">{currentDate}</h1>
                <h2 className="text-[#FFDDCC] font-medium text-lg flex gap-4 cursor-default">Check out our new
